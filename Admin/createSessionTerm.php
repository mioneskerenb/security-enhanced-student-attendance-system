...
if(isset($_POST['save'])){
    ...
    if($ret > 0){ 
        ...
        $statusMsg = "<div class='alert alert-danger shadow-sm' role='alert'>
                        ...
                        This Session and Term Already Exists!
                      </div>";
    }
    else{
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <div>
              ...
              <p class="mb-0 text-muted">
                Add, update, activate, and manage academic sessions and terms.
              </p>
            </div>
            ...
            <div class="card-body py-4">
              <div class="row align-items-center">
                ...
                <div class="col-lg-8">
                  ...
                  <p class="mb-0">
                    Create academic sessions, assign terms, and set the active session used for attendance records.
                  </p>
                </div>
              ...
              <div class="card shadow mb-4 border-0">
                ...
                <div class="card-header bg-white py-3 d-flex flex-row align-items-center justify-content-between border-bottom">
                  <h6 class="m-0 font-weight-bold text-success">
                    ...
                    <?php echo isset($Id) ? "Update Session and Term" : "Create Session and Term"; ?>
                  </h6>
                ...
                <div class="card-body">
                  ...
                  <form method="post">
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <div class="col-xl-6">
                        <label class="form-control-label font-weight-bold">
                          Session Name<span class="text-danger ml-2">*</span>
                        </label>
                      ...
                      <div class="col-xl-6">
                        ...
                        <div class="input-group">
                          ...
                          if ($num > 0){
                            echo '<select required name="termId" class="form-control">';
                            echo '<option value="">--Select Term--</option>';

                            while ($rows = $result->fetch_assoc()){
                              $selected = "";
                              if (isset($row['termId']) && $row['termId'] == $rows['Id']) {
                                $selected = "selected";
                              }
                    ...
                    ?>
                      ...
                      <a href="createSessionTerm.php" class="btn btn-secondary shadow-sm px-4 ml-2">
                  ...
                  <div class="card shadow mb-4 border-0">
                    ...
                    <div class="card-body">
                      ...
                      <div class="alert alert-success border-left-success shadow-sm" role="alert">
                        ...
                        Click the activate button to make a session and term active. Only one session and term should be active at a time.
                      </div>
                            ...
                            { 
                              while ($rows = $rs->fetch_assoc())
                              {
                                if($rows['isActive'] == '1'){
                                  ...
                                  $activateBtnClass = "btn btn-sm btn-secondary shadow-sm disabled";
                                } else {
                                  $status = "Inactive";
                                  $badgeClass = "badge badge-secondary px-3 py-2";
                                  $activateBtnClass = "btn btn-sm btn-success shadow-sm";
                                }
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <span class='font-weight-bold text-gray-800'>".$rows['sessionName']."</span>
                                  </td>

                                  <td>
                                    <span class='badge badge-info px-3 py-2'>".$rows['termName']."</span>
                                  </td>
                                  ...
                                  <td>
                                    <a href='?action=activate&Id=".$rows['Id']."' class='".$activateBtnClass."' onclick=\"return confirm('Set this session and term as active?');\">
                                  ...
                                  <td>
                                    <a href='?action=delete&Id=".$rows['Id']."' class='btn btn-sm btn-danger shadow-sm' onclick=\"return confirm('Are you sure you want to delete this session and term?');\">
